              ...
              <div className="table-responsive">
                <table className="table table-hover align-middle mb-0">
                  <thead className="bg-light">
                    <tr>
                      <th><i className="ti ti-user me-1" />Name</th>
                      <th><i className="ti ti-phone me-1" />Phone</th>
                      <th><i className="ti ti-building-store me-1" />Business</th>
                      <th><i className="ti ti-receipt me-1" />Bills</th>
                      <th><i className="ti ti-circle-check me-1" />Status</th>
                    ...
                    {!data || data.users.length === 0 ? (
                      ...
                      data.users.map((u) => (
                        <tr key={u.id}>
                          ...
                          <td>
                            <Link to={`/users/${u.id}`} className="btn btn-sm btn-outline-primary d-inline-flex align-items-center gap-1">
